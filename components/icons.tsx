...
export const TanstackQuery = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
...
export const FramerMotion = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
	<svg
		viewBox="0 0 256 384"
		width="1em"
		height="1em"
...
export const BetterAuth = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
	<svg
		width="60"
		height="45"
		viewBox="0 0 60 45"
...
export const ShadcnUI = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
	...
	>
		...
		<path fill="none" strokeWidth="20" stroke="currentColor" d="M208 128l-80 80M192 40L40 192" />
	</svg>
);
...
export const Microsoft = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
	<svg
		viewBox="0 0 256 256"
		xmlns="http://www.w3.org/2000/svg"
		width="256"
